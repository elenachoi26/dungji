        ...
        binding.others.onItemSelectedListener = object : AdapterView.OnItemSelectedListener{
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                if(spinnerKey == 1) {
                    ...
                    val intent = Intent(this@TimeTableActivity, OtherTimeTableActivity::class.java)
    ...
    private fun showAddTime() {
        ...
        with(builder) {
            ...
            setPositiveButton("추가"){dialog, which->
                ...
                database.child("timetable").child(auth.currentUser?.uid!!).child(timeTableId).setValue(TimeTable(timeTableId, title, week, startTime, endTime))
                drawTimeTable()
            }
